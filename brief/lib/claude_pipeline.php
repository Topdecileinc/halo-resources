...
function hp_load_context(array $cfg) {
    ...
    $preamble =
        ...
        . "CTA STYLING IS FOR THE BUTTON ONLY. The yellow fill (#FCD62D) and pill/rounded-button "
        . "styling are reserved exclusively for the single actual call-to-action button. NEVER render "
        . "an offer, discount, price, promo code, badge, eyebrow, or label as a filled or pill/rounded "
        . "box — present those as bold colored TEXT (Halo Yellow or body dark gray), with the price as "
        . "inline struck-through original next to the bold sale price, exactly as the example emails do. "
        . "A filled offer box next to the CTA looks like a second button and is strictly forbidden.\n\n"
